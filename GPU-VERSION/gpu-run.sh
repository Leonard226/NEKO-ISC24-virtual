...
# running NEKO on one GPU node, where one MPI task is explicitly mapped to one device
# select ucx as our underlying Process Management Layer 
# disable tcp, vader, openib as Byte Transfer Layer
